...
1. What does the term "semantics" mean in the context of programming?
...
4. What symbol ends statements in C?
...
6. What does the "%d" format specifier mean for printf?
...
8. What are the semantics of "break"?
